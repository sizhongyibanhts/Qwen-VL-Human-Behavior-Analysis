...
### 1.1 原有方法
behavior_detection.py，基于多模态大模型的“文本描述→违规推导”流程，先整体分析工位/人员行为（输出自然语言描述），再基于描述文本推导违规行为及坐标，核心依赖大模型的自然语言理解与生成能力。具体流程可以参考：https://zhuanlan.zhihu.com/p/2000642579801323159

### 1.2 优化后方法
behavior_detection_sahi.py,参考目标检测中的sahi的处理思路，基于“单人员独立识别+坐标位置计算”的流程，先对每个人员独立提取特征与坐标，通过坐标运算判断位置关系，再结合规则判定违规，减少大模型主观判断依赖。 具体流程可以参考：https://zhuanlan.zhihu.com/p/2000642579801323159
